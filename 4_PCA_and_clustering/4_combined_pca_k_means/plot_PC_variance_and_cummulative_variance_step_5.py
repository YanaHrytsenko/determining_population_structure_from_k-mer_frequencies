...
plt.ylabel('Variance %')
plt.xticks(PC)
plt.savefig("plot_variance_19_PCs_1_super_pop_3_pop_w_admixed_EUR_21mers.pdf")
...
plt.xticks(PC)
plt.savefig("Cumulative_Explained_Variance_1_super_pop_3_pop_w_admixed_EUR_21_mers.pdf")
plt.clf()
