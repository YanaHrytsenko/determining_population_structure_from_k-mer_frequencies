...
population = ['EAS_CDX', 'EAS_CDX', 'EAS_CDX', 'EAS_CDX', 'EAS_CDX', 'EAS_CDX',
              'EAS_CHB', 'EAS_CHB', 'EAS_CHB', 'EAS_CHB', 'EAS_CHB', 'EAS_CHB',
...
targets = ['EAS_CDX', 'EAS_CHB', 'EAS_JPT'] #make sure they are listed in the correct order
...
plt.savefig("2D_PCA_1_super_3_sub_pops_with_admixed_populations_18_samples_from_21kmer_freqs_EAS.pdf")
...
plt.ylabel('inertia')
plt.xticks(ks)
plt.savefig("elbow_method_plot_k_means_1_pop_w_admixed_EAS_21_mer_param.pdf")
plt.clf() #clear the plt variable so the plots don't overlap
...
plt.savefig("k_means_clustering_1_pop_w_admixed_EAS_21_mers_param.pdf")
